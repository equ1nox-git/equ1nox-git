...
Building local AI infrastructure and distributed systems on bare metal.

Currently: CS @ Butler Community College → WSU transfer track, targeting platform/cloud engineering.
...
**[OpenCode Agentic OS](https://github.com/equ1nox-git/opencode-agentic-os)** — 35 specialist agents for OpenCode. Education tutors, engineers, DevOps, sales, QA — each with a focused role. Zero-LLM math calculator answers arithmetic in under 100ms.
